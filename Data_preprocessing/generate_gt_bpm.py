...
if __name__ == "__main__":
    ...
    # ========== 配置区域 - 请修改这里的路径 ==========
    ppg_file_path = 'Data_for_pyVHR/gt_data/gt_lzj/HK-PPG-COM7_sig.npy'
    ts_file_path = 'Data_for_pyVHR/gt_data/gt_lzj/HK-PPG-COM7_ts.npy'
    gt_output_path = 'Data_for_pyVHR/gt_data/gt_lzj/bpms_times_GT'
